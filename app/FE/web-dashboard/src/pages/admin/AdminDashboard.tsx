...
const navigation = [
  ...
  { name: 'Menu', icon: UtensilsCrossed, path: '/admin-v2/menu' },
  { name: 'Tables', icon: Table, path: '/admin-v2/tables' },
  { name: 'Staff', icon: Users, path: '/admin-v2/staff' },
  { name: 'Analytics', icon: TrendingUp, path: '/admin-v2/analytics' },
  { name: 'Settings', icon: Settings, path: '/admin-v2/settings' },
];
        ...
        <div className="flex items-center justify-between px-5 py-5 border-b border-slate-200">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[10px] text-slate-400 font-body">Admin Panel</p>
            </div>
          </div>
...
function AdminDashboard() {
  ...
  const pageTitles: Record<string, string> = {
    '/admin-v2': 'Dashboard',
    '/admin-v2/menu': 'Menu Management',
    '/admin-v2/tables': 'Table Management',
    '/admin-v2/staff': 'Staff Management',
